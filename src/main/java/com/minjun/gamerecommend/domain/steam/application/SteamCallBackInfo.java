package com.minjun.gamerecommend.domain.steam.application;

import com.minjun.gamerecommend.domain.steam.dto.SteamCallBackInfoRequest;
...
@RequestMapping("/api")
public class SteamCallBackInfo {
    ...
    @GetMapping("/v1/steam/login-info")
